...
class GetSearchDataByText extends StatelessWidget {
  String? txt;
  int? type;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => SearchCubit()
        ...
        ..getSearchLibsTestByText(txt: type == 2 ? txt : null)
        ..getSearchSingleTestByText(txt: type == 3 ? txt : null),
          ...
          builder: (context, state) {
            ...
            return Scaffold(
              ...
              body: Stack(
                ...
                children: [
                  cubit.searchByText == null
                      ? Center(child: LoadingWidget())
                      : Container(
                          height: 540.h,
                          child: cubit.searchByText!.data!.isEmpty
                              ? Center(
                                  child: Column(
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    data = cubit.searchByText!.data![index];
                                    return GetTests(
                                      data: data,
                                      cubit: cubit,
                                    );
                                  ...
                                  itemCount: cubit.searchByText!.data!.length),
                        ),
